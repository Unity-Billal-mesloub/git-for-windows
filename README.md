[![Build status](https://github.com/Unity-Billal-mesloub/git-for-windows/workflows/CI/badge.svg)](https://github.com/Unity-Billal-mesloub/git-for-windows/actions?query=branch%3Amaster+event%3Apush)
